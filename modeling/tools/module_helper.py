...
from utils2.utils.tools.logger import Logger as Log
...
class ModuleHelper(object):
    ...
    def BNReLU(num_features, norm_type=None, **kwargs):
        if norm_type == 'batchnorm':
            ...
            # from modeling.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d as BatchNorm2d
            # return nn.Sequential(
            #     BatchNorm2d(num_features, **kwargs),
            #     nn.ReLU()
            # )
            from network.nn.mynn import Norm2d as BatchNorm2d
            return nn.Sequential(
                BatchNorm2d(num_features, **kwargs),
                nn.ReLU()
            )
    ...
    def BatchNorm3d(norm_type=None, ret_cls=False):
        if norm_type == 'batchnorm':
            ...
            from modeling.sync_batchnorm.batchnorm import SynchronizedBatchNorm3d as BatchNorm3d
            return BatchNorm3d
    ...
    def BatchNorm1d(norm_type=None, ret_cls=False):
        if norm_type == 'batchnorm':
            ...
            from modeling.sync_batchnorm.batchnorm import SynchronizedBatchNorm1d as BatchNorm1d
            return BatchNorm1d
